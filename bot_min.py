...
def process_rows(rows):
    ...
    for row in rows:
        ...
        contact_prompt = (
            ...
            f"{agent_name} in {state}. Respond in JSON with keys 'phone' and "
            "'email'."
        )
        ...
        if not any(r.get("phone") == phone for r in all_records):
            ...
            sms_body = (
                ...
                "I saw your short sale listing at {address} and wanted to "
                "introduce myself. "
                "I specialize in helping agents get faster bank approvals "
                "and ensure these deals close. "
                "I know you likely handle short sales "
                "yourself, but I work behind the scenes to take on lender "
                "negotiations so you can focus on selling. No cost to you or "
                "your client—I'm only paid by the buyer at closing. "
